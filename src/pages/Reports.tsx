  ...
  useEffect(() => {
    if (selectedTest?.extra) {
      try {
        ...
        if (extraData.tcOutputs && Array.isArray(extraData.tcOutputs)) {
        ...
        setTcOutputs([{ metricName: '', metricFormulaImg: null, resultSummary: '', evidenceCount: 1, evidences: [{ title: '', description: '', images: [] }], metricTarget: '', metricResult: '', metricEvaluation: '' }]);
      ...
      <main className="dashboard-grid animate-fade-in" style={{ paddingBottom: '4rem' }}>
        <header className="card" style={{ gridColumn: '1 / -1', background: 'var(--kaic-navy)', color: 'white', padding: '1.5rem 2rem' }}>
           <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
             <h2 style={{ margin: 0 }}>성적서 작성 관리</h2>
             <button 
               className="btn" 
